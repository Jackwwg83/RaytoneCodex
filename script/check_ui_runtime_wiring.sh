...
settings_runtime = {
    "general": ["refreshRuntimeCatalog", "saveRuntimeWorkMode", "saveRuntimeShowInMenuBar"],
    ...
    "git": ["command/exec", "git diff", "gh repo create", "runGitCreateRepositoryInTerminal", "runGitPushCurrentBranchInTerminal", "--git-repo-create-smoke-test", "--git-push-smoke-test", "--runtime-environment-smoke-test"],
...
tool_panels = {
    "launcher": ["EnvironmentInfoPanel", "private var launcher"],
    "browser": [
        "BrowserPanelView",
        "WKWebView",
        "fs/getMetadata",
